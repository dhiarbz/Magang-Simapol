            ...
            <div class="content-wrapper">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.fupdate_user', ['id' => $users->id])  }}" method="POST" enctype="multipart/form-data" class="form-sample">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="nrp" name="nrp" value="{{ $users->nrp }}" required>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                                <label for="password" class="col-sm-3 col-form-label">Password</label>
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" id="password" name="password" placeholder="Password Sama Seperti NRP" >
                                </div>
                            </div>
