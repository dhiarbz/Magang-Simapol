  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-10 p-4">
        <div class="content">
          <h2 class="mb-4" style="font-weight: 700;">Data Laporan</h2>

            <a class="btn btn-primary mb-3" style="max-width: 250px;" href="{{ route('admin.add_laporan') }}">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $l->created_at->format('d/m/Y') }}</td>
                 <td>
                   <a href="{{ route('admin.preview', ['laporan' => $l->id]) }}" class="btn btn-success"><i class="fas fa-download"></i> Download</a>
                    <a href="{{ route('admin.detail_laporan', ['id' => $l->id]) }}" class="btn btn-sm btn-primary"><i class="fa-regular fa-eye"></i> Lihat Detail</a>
                    <a href="{{ route('admin.update_laporan', ['id' => $l->id]) }}" class="btn btn-warning btn-sm">
                        <i class="fas fa-edit"></i> Edit
                    </a>
                    <form action="{{ route('admin.delete_laporan', ['id' => $l->id]) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
