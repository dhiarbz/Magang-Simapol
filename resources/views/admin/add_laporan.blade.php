            ...
            <div class="content-wrapper">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.fadd_laporan') }}" method="POST" enctype="multipart/form-data" class="form-sample">
                            @csrf
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="ttg" name="ttg" placeholder="Masukkan Tempat, tanggal lahir" required>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="alamat_ktp" name="alamat_ktp" placeholder="Masukkan Alamat" required>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                                <label for="domisili" class="col-sm-3 col-form-label">Alamat Domisili</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="alamat_domisili" name="alamat_domisili" placeholder="Masukkan Domisili" required>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="isi_laporan" id="isi_laporan" cols="30" rows="10" placeholder="Isi Laporan">{{ old('isi_laporan') }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
